...
# --- Configuration ---
# Switched to a tiny setup for fast CPU training
DUMMY_DATASET_PATH = "dummy_training_data.txt" 
BATCH_SIZE = 4
SEQUENCE_LENGTH = 64  # Reduced for speed
EPOCHS = 10

def create_and_save_dummy_dataset(file_path, num_sentences=500, vocab_size=500, max_len=15): # Reduced dataset size
...
def main():
    ...
    # Use the new TINY model function
    ...
    print(f"\n--- Starting Training on a Single Device for {EPOCHS} Epochs ---")
